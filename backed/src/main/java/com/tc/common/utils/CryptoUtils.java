...
import com.tc.common.utils.CryptoUtils.Algorithm.Encryption;
import com.tc.common.utils.CryptoUtils.Algorithm.Signing;
...
public class CryptoUtils {
    ...
    public static void main(String[] args) throws Exception {
        String secretKey = "AyYkmAVZ6XsUes0ICjq5TA==";
        String cipherText = CryptoUtils.encryptSymmetrically(secretKey, null, "admin", Encryption.AES_ECB_PKCS5);
